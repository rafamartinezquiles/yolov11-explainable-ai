...
visualization = show_factorization_on_image(img_with_boxes, batch_explanations[0], image_weight=0.0)

visualization = cv2.resize(visualization, (orig_plot.shape[1], orig_plot.shape[0]))
both = cv2.addWeighted(visualization, 0.5, orig_plot, 0.5, 0)
